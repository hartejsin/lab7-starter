...
function initFormHandler() {
	...
	form.addEventListener('submit', function(event) {
		...
		// B5. Create an empty object and then extract the keys and corresponding values from the FormData object
		const recipeObject = {};
	...
	const clearStorageBtn = document.querySelector('button.danger');
